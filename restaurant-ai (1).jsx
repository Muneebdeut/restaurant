...
const primaryBtn = {
  background: `linear-gradient(135deg, ${T.orange}, #FF9500)`, color: "#fff",
...
function Landing({ onStart, onAdmin }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: T.bg, color: T.white, fontFamily: "Inter, sans-serif" }}>
      {/* Navbar */}
      <nav style={{
        ...
        background: `${T.bg}ee`, backdropFilter: "blur(16px)", zIndex: 100,
      }}>
        <div style={{ fontWeight: 900, fontSize: 19, letterSpacing: -0.5 }}>
          <span style={{ color: T.orange }}>🍽️</span> <span>RestaurantAI</span>
        </div>
      ...
      {/* Hero */}
      <div style={{ textAlign: "center", padding: "88px 24px 64px", maxWidth: 860, margin: "0 auto" }}>
        <div style={{
        ...
        <button onClick={onStart} style={{ ...primaryBtn, padding: "18px 52px", fontSize: 17, borderRadius: 14 }}>
          Start Free Assessment 🚀
        </button>
        <div style={{ color: T.grey, fontSize: 13, marginTop: 18, display: "flex", gap: 24, justifyContent: "center", flexWrap: "wrap" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(130px, 1fr))", maxWidth: 680, margin: "0 auto 80px", padding: "0 24px", gap: 2 }}>
        {metrics.map((m, i) => (
          <div key={i} style={{
            ...
            background: i % 2 === 0 ? T.surface : T.surf2,
            ...
            <div style={{ color: T.grey, fontSize: 12, marginTop: 4 }}>{m.label}</div>
          </div>
        ))}
      </div>
      ...
      <div style={{ maxWidth: 1020, margin: "0 auto", padding: "0 24px 80px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 20 }}>
          {benefits.map((b, i) => (
            <div key={i} style={{ ...card, border: `1px solid rgba(255,107,53,0.12)`, transition: "border-color 0.2s, transform 0.2s" }}
              onMouseEnter={e => { e.currentTarget.style.borderColor = `${T.orange}40`; e.currentTarget.style.transform = "translateY(-3px)"; }}
              onMouseLeave={e => { e.currentTarget.style.borderColor = "rgba(255,107,53,0.12)"; e.currentTarget.style.transform = "none"; }}>
              <div style={{ fontSize: 38, marginBottom: 16 }}>{b.icon}</div>
              <div style={{ fontWeight: 700, fontSize: 16, marginBottom: 10 }}>{b.title}</div>
              <div style={{ color: T.grey, fontSize: 14, lineHeight: 1.7 }}>{b.desc}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* How it works */}
      <div style={{ background: T.surface, borderTop: `1px solid ${T.border}`, borderBottom: `1px solid ${T.border}`, padding: "64px 24px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 0 }}>
            {[
              ...
              <div key={i} style={{ padding: "24px 20px", position: "relative" }}>
                ...
                <div style={{ color: T.grey, fontSize: 13, lineHeight: 1.6 }}>{item.desc}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ textAlign: "center", padding: "72px 24px 80px" }}>
        ...
        <p style={{ color: T.grey, marginBottom: 32, fontSize: 15 }}>Join 100+ restaurants already powered by AI</p>
        <button onClick={onStart} style={{ ...primaryBtn, fontSize: 17, padding: "18px 52px", borderRadius: 14 }}>
...
function FormPage({ onSubmit, onBack }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: T.bg, color: T.white, fontFamily: "Inter, sans-serif", padding: "20px 16px" }}>
      <div style={{ maxWidth: 740, margin: "0 auto" }}>
        ...
        {/* Form card */}
        <div style={{ ...card, border: `1px solid rgba(255,107,53,0.2)`, marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
          ...
          <button onClick={() => step < 4 ? setStep(s => s + 1) : onSubmit(d)}
            disabled={!valid()}
...
function LoadingPage() {
  ...
  return (
    <div style={{
      minHeight: "100vh", background: T.bg, color: T.white, fontFamily: "Inter, sans-serif",
      ...
      <div style={{ textAlign: "center", maxWidth: 460, padding: "24px 24px" }}>
        ...
        <p style={{ color: T.grey, marginBottom: 40, fontSize: 14 }}>Usually takes 10–20 seconds</p>
        <div>
          {msgs.map((m, i) => (
            <div key={i} style={{
    ...
    <div style={{ minHeight: "100vh", background: T.bg, color: T.white, fontFamily: "Inter, sans-serif", padding: "20px 16px" }}>
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", padding: "44px 0 36px" }}>
          ...
          <p style={{ color: T.grey, fontSize: 15 }}>
        ...
        {/* Score Card */}
        <div style={{ ...card, border: `1px solid ${T.orange}35`, marginBottom: 20, textAlign: "center", padding: "36px 28px" }}>
          <div style={{ fontSize: 11, color: T.grey, textTransform: "uppercase", letterSpacing: 2, fontWeight: 700, marginBottom: 20 }}>
            AI Readiness Score
          </div>
          <div style={{ fontSize: 80, fontWeight: 900, color: T.orange, lineHeight: 1, letterSpacing: -4 }}>
            {animScore}
            <span style={{ fontSize: 36, color: T.grey, fontWeight: 600, letterSpacing: 0 }}>/100</span>
          </div>
        ...
        <div style={{ ...card, border: `1px solid ${T.orange}25`, marginBottom: 20 }}>
          ...
          <p style={{ color: T.grey2, lineHeight: 1.8, marginBottom: 24, fontSize: 14 }}>{result.agentDescription}</p>
          <div style={{ fontSize: 12, fontWeight: 700, marginBottom: 12, color: T.grey, textTransform: "uppercase", letterSpacing: 1 }}>Features Included:</div>
        ...
        {/* Expected Benefits */}
        <div style={{ ...card, border: `1px solid ${T.green}25`, marginBottom: 20 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(155px, 1fr))", gap: 14 }}>
            {(result.expectedBenefits || []).map((b, i) => (
              <div key={i} style={{
                ...
                <div style={{ color: T.grey, fontSize: 12, lineHeight: 1.4 }}>{b.metric}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 20 }}>
          {[
            ...
            <div key={i} style={{ ...card, textAlign: "center" }}>
              ...
              <div style={{ color: T.grey, fontSize: 13 }}>{item.label}</div>
            </div>
          ))}
        </div>
        ...
        {result.automationOpportunities?.length > 0 && (
          <div style={{ ...card, border: `1px solid ${T.gold}22`, marginBottom: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {result.automationOpportunities.map((o, i) => (
                <div key={i} style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                  ...
                  <span style={{ color: T.grey2, fontSize: 14, lineHeight: 1.7 }}>{o}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        {result.priorityFeatures?.length > 0 && (
          <div style={{ ...card, marginBottom: 20 }}>
            <div style={{ fontSize: 10, color: T.grey, textTransform: "uppercase", letterSpacing: 2, fontWeight: 800, marginBottom: 14 }}>
        ...
        <div style={{ ...card, marginBottom: 32 }}>
          <div style={{ fontSize: 10, color: T.grey, textTransform: "uppercase", letterSpacing: 2, fontWeight: 800, marginBottom: 12 }}>
            AI Analysis Notes
          </div>
          <p style={{ color: T.grey2, fontSize: 14, lineHeight: 1.8, margin: 0 }}>{result.reasoning}</p>
        </div>
...
function AdminDashboard({ onBack }) {
  ...
  if (!auth) return (
    <div style={{
      ...
      <div style={{ ...card, border: `1px solid ${T.orange}25`, width: 340, textAlign: "center", padding: 36 }}>
        <div style={{ fontSize: 48, marginBottom: 20 }}>🔐</div>
        <h2 style={{ fontWeight: 900, marginBottom: 6, fontSize: 22 }}>Admin Access</h2>
        <p style={{ color: T.grey, fontSize: 13, marginBottom: 24 }}>Enter your admin password to view leads</p>
        <input
        ...
        <div style={{ color: T.grey, fontSize: 11, marginTop: 16 }}
      </div>
    </div>
  );
  ...
  if (selected) return (
    <div style={{ minHeight: "100vh", background: T.bg, color: T.white, fontFamily: "Inter, sans-serif", padding: "20px 16px" }}>
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <div style={{ ...card, border: `1px solid ${catColor[selected.leadCategory] || T.border}30`, marginBottom: 20 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12, marginBottom: 24, paddingBottom: 24, borderBottom: `1px solid ${T.border}` }}>
            <div>
              ...
              <div style={{ color: T.grey, fontSize: 14 }}>{selected.city} • {selected.restaurantType}</div>
            </div>
            <div style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 20 }}>
            {[
              ...
              <div key={i}>
                <div style={{ fontSize: 11, color: T.grey, fontWeight: 700, textTransform: "uppercase", letterSpacing: 1, marginBottom: 4 }}>{item.label}</div>
          ...
          {selected.challenges?.length > 0 && (
            <div style={{ marginTop: 24 }}>
              <div style={{ fontSize: 11, color: T.grey, fontWeight: 700, textTransform: "uppercase", letterSpacing: 1, marginBottom: 10 }}>Pain Points</div>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
          ...
          {selected.contactChannels?.length > 0 && (
            <div style={{ marginTop: 20 }}>
              <div style={{ fontSize: 11, color: T.grey, fontWeight: 700, textTransform: "uppercase", letterSpacing: 1, marginBottom: 10 }}>Contact Channels</div>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 32, paddingTop: 12, flexWrap: "wrap", gap: 16 }}>
          <div>
            ...
            <div style={{ color: T.grey, fontSize: 13 }}>{leads.length} total leads • Last updated just now</div>
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 14, marginBottom: 28 }}>
          {[
            ...
            <div key={i} style={{ ...card, padding: "20px 22px" }}>
              ...
              <div style={{ color: T.grey, fontSize: 12, marginTop: 4 }}>{s.label}</div>
            </div>
          ))}
        </div>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 20, flexWrap: "wrap", alignItems: "center" }}>
          <span style={{ color: T.grey, fontSize: 12, fontWeight: 700, textTransform: "uppercase", letterSpacing: 1 }}>Filter:</span>
          {["all", "Hot", "Warm", "Cold"].map(f => (
            <button key={f} onClick={() => setCatFilter(f)} style={{
              ...
              color: catFilter === f ? "#fff" : T.grey, padding: "7px 18px",
          ...
          {(catFilter !== "all" || citySearch) && (
            <button onClick={() => { setCatFilter("all"); setCitySearch(""); }}
              style={{ ...ghostBtn, padding: "7px 14px", fontSize: 12, color: T.grey }}>
              ✕ Clear
            </button>
          )}
          <span style={{ color: T.grey, fontSize: 12, marginLeft: 4 }}>({filtered.length} results)</span>
        </div>

        {/* Table */}
        {filtered.length === 0 ? (
          <div style={{ textAlign: "center", padding: "72px 0", color: T.grey }}>
            <div style={{ fontSize: 52, marginBottom: 16 }}>📭</div>
          ...
          <div style={{ overflowX: "auto", borderRadius: 16, border: T.border, background: T.surface }}>
            <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 820 }}>
              <thead>
                <tr style={{ borderBottom: `1px solid ${T.border}` }}>
                  {["Date", "Owner", "Restaurant", "City", "Phone", "Score", "Category", "Agent", "Budget", ""].map(h => (
                    <th key={h} style={{ padding: "13px 16px", textAlign: "left", fontSize: 10, color: T.grey, fontWeight: 700, textTransform: "uppercase", letterSpacing: 1, whiteSpace: "nowrap" }}>
                      {h}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {filtered.map((l, i) => (
                  <tr key={i}
                    ...
                    <td style={{ padding: "13px 16px", fontSize: 12, color: T.grey, whiteSpace: "nowrap" }}>{l.date}</td>
                    ...
                    <td style={{ padding: "13px 16px", fontSize: 13, color: T.grey }}>{l.city}</td>
                    <td style={{ padding: "13px 16px", fontSize: 12, color: T.grey }}>{l.phone}</td>
                    <td style={{ padding: "13px 16px" }}>
                      <span style={{ fontWeight: 900, fontSize: 15, color: (l.aiReadinessScore||0) >= 75 ? T.green : (l.aiReadinessScore||0) >= 50 ? T.gold : T.red }}>
                        {l.aiReadinessScore || "—"}
                        {l.aiReadinessScore ? <span style={{ fontSize: 11, fontWeight: 500, color: T.grey }}>/100</span> : ""}
                      </span>
                    </td>
                    <td style={{ padding: "13px 16px" }}>
                      {l.leadCategory ? (
                    ...
                    <td style={{ padding: "13px 16px", fontSize: 12, color: T.grey, maxWidth: 180, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {l.agentType || "—"}
                    </td>
                    <td style={{ padding: "13px 16px", fontSize: 12, color: T.grey, whiteSpace: "nowrap" }}>{l.budget || "—"}</td>
                    <td style={{ padding: "13px 16px" }}>
...
Choose agentType based on primary channel: WhatsApp dominant → WhatsApp agent. Calls dominant → AI Call Handler. Multiple channels → Omni-channel agent. Multi-branch → Enterprise AI System.`;
  ...
  if (page === PAGES.LANDING) return <Landing onStart={() => setPage(PAGES.FORM)} onAdmin={() => setPage(PAGES.ADMIN)} />;
  if (page === PAGES.FORM)    return <FormPage onSubmit={handleSubmit} onBack={() => setPage(PAGES.LANDING)} />;
  if (page === PAGES.LOADING) return <LoadingPage />;
  if (page === PAGES.RESULT)  return <ResultPage result={aiResult} formData={formData} onReset={reset} />;
  if (page === PAGES.ADMIN)   return <AdminDashboard onBack={() => setPage(PAGES.LANDING)} />;
  return null;
}
