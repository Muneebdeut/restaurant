  ...
  return (
    <div className="page-shell" style={{ minHeight: "100vh", background: "transparent", color: T.white, fontFamily: "Inter, sans-serif" }}>
      ...
      {(() => {
        const scenes = [
          {
            title: "Scene 1: The Problem (0–15 sec)",
            icon: "🏪",
            desc: "Show a busy restaurant during peak hours. Staff are overwhelmed as phones keep ringing, WhatsApp messages flood in, customers wait for replies, and orders are delayed. The restaurant owner looks stressed trying to manage everything at once.",
            english: "Running a restaurant is challenging. Every missed call, delayed response, or unanswered customer message can mean a lost sale.",
            urdu: "ایک ریسٹورنٹ چلانا کافی مشکل کام ہے۔ ہر وہ کال جو مس ہو جائے، تاخیر سے دیا گیا جواب، یا گاہک کا بغیر جواب کا میسج—ایک قیمتی آرڈر کھونے کا سبب بن سکتا ہے۔"
          },
          {
            title: "Scene 2: Introducing the Solution (15–35 sec)",
            icon: "🤖",
            desc: "Transition to sleek AI visuals with modern dashboards, chat interfaces, voice assistants, and automation technology. Show an AI assistant instantly replying to WhatsApp, taking orders, booking tables, confirming delivery, and upselling.",
            features: [
              "24/7 AI Customer Support (اے آئی کسٹمر سپورٹ)",
              "Instant WhatsApp Replies (فوری واٹس ایپ جوابات)",
              "AI Order Taking (اے آئی آرڈر ٹیکنگ)",
              "Voice Call Assistant (وائس کال اسسٹنٹ)",
              "Reservation Management (ریزرویشن مینجمنٹ)"
            ],
            english: "Meet your restaurant's new AI assistant. Available 24 hours a day to serve your customers, automate repetitive tasks, and help your business grow.",
            urdu: "ملیں اپنے ریسٹورنٹ کے نئے اے آئی اسسٹنٹ سے! جو دن کے 24 گھنٹے آپ کے کسٹمرز کو جواب دینے، آرڈرز لینے، اور آپ کے کاروبار کو بڑھانے کے لیے حاضر ہے۔"
          },
          {
            title: "Scene 3: The Results (35–55 sec)",
            icon: "📈",
            desc: "Show the restaurant running smoothly. Staff are relaxed, customers are happy, orders are processed quickly, and the owner smiles while viewing positive sales and analytics on a dashboard.",
            stats: [
              "Faster Response Time (فوری جوابات)",
              "More Customer Satisfaction (خوش اور مطمئن گاہک)",
              "Increased Revenue (سیلز میں اضافہ)",
              "Reduced Operational Costs (اخراجات میں کمی)"
            ],
            english: "With AI automation from MS Tech, your restaurant can respond faster, improve customer experience, and focus on what matters most—serving great food.",
            urdu: "ایم ایس ٹیک (MS Tech) کی جدید آٹومیشن کے ساتھ، آپ کا ریسٹورنٹ فوری جواب دے سکتا ہے، گاہکوں کے تجربے کو لاجواب بنا سکتا ہے، اور آپ اپنے اصل کام یعنی لذیذ کھانا پیش کرنے پر توجہ مرکوز کر سکتے ہے۔"
          },
          {
            title: "Scene 4: Website & Assessment (55–75 sec)",
            icon: "🌐",
            desc: "Show a laptop and smartphone displaying the MS Tech website. A restaurant owner clicks 'Get Started' and fills out a simple business assessment form (Restaurant Name, Daily Orders, Challenges, Menu upload).",
            english: "Visit the MS Tech website and complete our quick restaurant assessment. Tell us about your business, upload your menu, and let us understand your needs.",
            urdu: "آج ہی ایم ایس ٹیک کی ویب سائٹ وزٹ کریں اور ہمارا تیز رفتار ریسٹورنٹ اسسمنٹ مکمل کریں۔ اپنے ریسٹورنٹ کے بارے میں بتائیں، مینو اپ لوڈ کریں، اور ہمیں اپنی ضروریات سے آگاہ کریں۔"
          },
          {
            title: "Scene 5: Our Team (75–85 sec)",
            icon: "👥",
            desc: "Show professional MS Tech team members reviewing the submitted information, discussing automation strategies, designing AI workflows, and building a customized AI assistant.",
            english: "Our experts analyze every submission and design a customized AI solution tailored specifically for your restaurant.",
            urdu: "ہمارے اے آئی ایکسپرٹس ہر اسسمنٹ کا گہرائی سے جائزہ لیتے ہیں اور خاص طور پر آپ کے ریسٹورنٹ کے لیے ایک بہترین اور منفرد اے آئی اسسٹنٹ تیار کرتے ہیں۔"
          },
          {
            title: "Final Scene: Call to Action (85–90 sec)",
            icon: "📢",
            desc: "Premium dark-copper background with subtle glowing technology animations. Displaying MS Tech logo, AI Automation for Restaurants, Free Business Assessment.",
            english: "MS Tech — Smarter Restaurants. Better Customer Experience. Powered by AI.",
            urdu: "ایم ایس ٹیک (MS Tech)—ذہین ریسٹورنٹس۔ بہتر کسٹمر سروس۔ اے آئی کی جدید ترین طاقت کے ساتھ۔"
          }
        ];

        return (
          <div style={{ maxWidth: 840, margin: "72px auto 20px", padding: "0 24px" }}>
            <div style={{ textAlign: "center", marginBottom: 36 }}>
              <div className="badge-pill" style={{
                display: "inline-block", background: `${T.orange}18`, border: `1px solid ${T.orange}30`,
                color: T.orange, borderRadius: 24, padding: "5px 20px", fontSize: 11,
                fontWeight: 700, marginBottom: 12, letterSpacing: 1, textTransform: "uppercase",
              }}>
                🎥 AI Video Commercial Script (Urdu)
              </div>
              <h2 style={{ fontSize: "clamp(22px, 3vw, 32px)", fontWeight: 800, margin: "0 0 10px", letterSpacing: -0.5 }}>
                MS Tech Promotional Video Script
              </h2>
              <p style={{ color: T.grey2, fontSize: 14, maxWidth: 500, margin: "0 auto" }}>
                Experience our 90-second commercial script concept, with visual directives and professional Urdu voice-overs.
              </p>
            </div>

            <div className="glass-card" style={{
              ...card, background: "rgba(26, 20, 18, 0.6)", border: `1px solid ${T.orange}25`,
              padding: "32px 28px", minHeight: 380, display: "flex", flexDirection: "column", justifyContent: "space-between"
            }}>
              {/* Header of Player */}
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: `1px solid ${T.border}`, paddingBottom: 16, marginBottom: 20 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <div style={{ fontSize: 28 }}>{scenes[sceneIdx].icon}</div>
                  <div style={{ textAlign: "left" }}>
                    <div style={{ fontSize: 10, color: T.orange, fontWeight: 800, letterSpacing: 1, textTransform: "uppercase", marginBottom: 2 }}>Scene {sceneIdx + 1} of {scenes.length}</div>
                    <div style={{ fontSize: 16, fontWeight: 700, color: T.white }}>{scenes[sceneIdx].title}</div>
                  </div>
                </div>
                <div style={{ fontSize: 12, color: T.grey, background: "rgba(255,255,255,0.03)", padding: "4px 10px", borderRadius: 12, border: "1px solid rgba(255,255,255,0.06)" }}>
                  ⏱️ {sceneIdx === 5 ? "5s" : sceneIdx === 4 ? "10s" : "20s"}
                </div>
              </div>

              {/* Body content of Player */}
              <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 16, textAlign: "left" }}>
                <div>
                  <div style={{ fontSize: 10, color: T.grey2, fontWeight: 700, textTransform: "uppercase", letterSpacing: 1, marginBottom: 4 }}>Visual Direction (سین کی تفصیل)</div>
                  <p style={{ color: T.grey2, fontSize: 14, lineHeight: 1.6, margin: 0 }}>{scenes[sceneIdx].desc}</p>
                </div>

                {scenes[sceneIdx].features && (
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 8, margin: "4px 0" }}>
                    {scenes[sceneIdx].features.map((f, i) => (
                      <span key={i} style={{ fontSize: 11, background: `${T.orange}10`, color: T.orange, border: `1px solid ${T.orange}20`, padding: "4px 10px", borderRadius: 12, fontWeight: 600 }}>{f}</span>
                    ))}
                  </div>
                )}

                {scenes[sceneIdx].stats && (
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 8, margin: "4px 0" }}>
                    {scenes[sceneIdx].stats.map((s, i) => (
                      <span key={i} style={{ fontSize: 11, background: `${T.green}10`, color: T.green, border: `1px solid ${T.green}20`, padding: "4px 10px", borderRadius: 12, fontWeight: 600 }}>{s}</span>
                    ))}
                  </div>
                )}

                {/* Voice Overs */}
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginTop: 12, borderTop: `1px solid ${T.border}`, paddingTop: 16 }}>
                  <div>
                    <div style={{ fontSize: 10, color: T.grey2, fontWeight: 700, textTransform: "uppercase", letterSpacing: 1, marginBottom: 8 }}>Voice-over (Urdu - اردو وائس اوور)</div>
                    <p style={{ color: T.white, fontSize: 16, fontWeight: 600, lineHeight: 1.8, margin: 0, direction: "rtl", textAlign: "right" }}>{scenes[sceneIdx].urdu}</p>
                  </div>
                  <div style={{ borderLeft: `1px solid ${T.border}`, paddingLeft: 20 }}>
                    <div style={{ fontSize: 10, color: T.grey2, fontWeight: 700, textTransform: "uppercase", letterSpacing: 1, marginBottom: 8 }}>Voice-over (English)</div>
                    <p style={{ color: T.grey2, fontSize: 13, lineHeight: 1.6, fontStyle: "italic", margin: 0 }}>"{scenes[sceneIdx].english}"</p>
                  </div>
                </div>
              </div>

              {/* Footer Controls of Player */}
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: `1px solid ${T.border}`, paddingTop: 16, marginTop: 24 }}>
                <div style={{ display: "flex", gap: 4 }}>
                  {scenes.map((_, i) => (
                    <div key={i} style={{ width: 8, height: 8, borderRadius: 99, background: i === sceneIdx ? T.orange : "rgba(255,255,255,0.15)", cursor: "pointer", transition: "background 0.2s" }} onClick={() => setSceneIdx(i)} />
                  ))}
                </div>
                <div style={{ display: "flex", gap: 10 }}>
                  <button className="btn-3d btn-ghost" onClick={() => setSceneIdx(i => Math.max(0, i - 1))} disabled={sceneIdx === 0} style={{ ...ghostBtn, padding: "8px 16px", fontSize: 13, opacity: sceneIdx === 0 ? 0.3 : 1 }}>
                    ← Prev Scene
                  </button>
                  <button className="btn-3d" onClick={() => setSceneIdx(i => Math.min(scenes.length - 1, i + 1))} disabled={sceneIdx === scenes.length - 1} style={{ ...primaryBtn, padding: "8px 16px", fontSize: 13, opacity: sceneIdx === scenes.length - 1 ? 0.3 : 1 }}>
                    Next Scene →
                  </button>
                </div>
              </div>
